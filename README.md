[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=17816678)
# Sp25Lab2
...
* the big-O worst-case complexity is Nlog(N), and
* the big-O best-case complexity is N.

Referring to the code block below,
* the big-O worst-case complexity of the function **search** is 2^N.
  ```python
  def search(lst, key):
...
I would use the function **search** (defined above) in real life because it allows the program to quickly find the key without searching through the entire list, which drastically decreases the runtime.
